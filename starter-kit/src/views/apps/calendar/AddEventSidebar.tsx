  ...
  const resetToStoredValues = useCallback(() => {
    if (store.selectedEvent !== null) {
      ...
      setValues({
        ...
        calendar: event.extendedProps.calendar || 'Unidad',
    ...
    >
      ...
      >
        <Typography variant='h5'>
          {store.selectedEvent !== null && store.selectedEvent.title.length ? 'Actualizar Evento' : 'Añadir Evento'}
        </Typography>
        ...
        <DatePickerWrapper>
          <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
            ...
            >
              ...
              <MenuItem value='Unidad'>Unidad por Defecto</MenuItem>
            ...
            <Box sx={{ mb: 4 }}>
              <DatePicker
                ...
                showTimeSelect={!values.allDay}
                dateFormat={!values.allDay ? 'yyyy-MM-dd hh:mm' : 'yyyy-MM-dd'}
                customInput={<PickersComponent label='Fecha de Finalización' registername='endDate' />}
